...
class Route:
    ...
    def dist_at(self, idx: int) -> DistanceSegment: ...
    def dist_between(self, start: int, end: int) -> DistanceSegment: ...
    def dist_before(self, end: int) -> DistanceSegment: ...
    def dist_after(self, start: int) -> DistanceSegment: ...
    ...
    def duration_at(self, idx: int) -> DurationSegment: ...
    def duration_between(self, start: int, end: int) -> DurationSegment: ...
